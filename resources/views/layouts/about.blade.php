    ...
    <div class="container-fluid" style="padding-top: 112px">
        <div class="row">
            <div class="col-12 d-flex p-0 pb-5" style="max-height: 1000px;">
                <div class="col-6 d-flex flex-column align-items-center justify-content-center roboto-font" style="padding: 3rem 7rem">
                    <h1 class="abril-font center-title mb-5">ABOUT US</h1>
