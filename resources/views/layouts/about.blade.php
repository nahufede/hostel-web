    ...
    <div class="container-fluid" style="padding-top: 139px">
        <div class="row">
            <div class="col-12 d-flex p-0 pb-5">
                <div class="col-6 d-flex flex-column align-items-center justify-content-evenly roboto-font" style="padding: 3rem 6rem">
                    <h1 class="abril-font center-title">ABOUT US</h1>
                    <h4 class="m-0">How It All Started</h4>
                    <p class="text-center px-4 m-0">LUMO began when two like minds decided to bring together their skills, passion and love for gin to create a place where they could focus on doing what they love, for those they love.</p>
                    <p class="text-center px-4 m-0">Their calling is branding for passion-led businesses and startups, maybe it is the shared passion, determination and coffee adoration that helped forged the foundations of why they do what they do, and how they do it so well.</p>
                    <img src="../img/about/0-1-min.jpg" alt="">
                </div>
                <div class="col-6">
                    <img src="../img/about/0-2-min.jpg" alt="">
                </div>
            </div>
        </div>
        <div class="row mypad">
            <div class="about-first-wrapper roboto-font">
                <div class="about-first-top-left d-flex flex-column justify-content-between">
                    <h1 class="abril-font center-title">IMOGEN<i class="bi bi-arrow-right ps-2"></i></h1>
                    <h5>Creative Director</h5>
                    <p class="pe-4">Imogen is the detail. Imogen’s eye for the finer things was nursed through her studies in architecture. But soon she realised her true passion lay in using that fastidious eye to create millimetre-perfect graphic design and marketing. This way, she’s able to create brands and websites that not only look bloody good but help business owners take things to the next level, too.</p>
                </div>
                <div class="about-first-top-right">
                    <img src="../img/about/1-1-min.jpg" alt="">
                </div>
                <div class="about-first-bottom-left">
                    <img src="../img/about/1-2-min.jpg" alt="">
                </div>
                <div class="about-first-bottom-right d-flex flex-column justify-content-between">
                    <h1 class="abril-font center-title"><i class="bi bi-arrow-left pe-2"></i>LUCY</h1>
                    <h5>Managing Director</h5>
                    <p class="pe-4">Lucy is the big thinker. She has over ten years of experience in creative communications—from journalism and travel videography to freelance design and brand management for big honchos. With a broad background and an acute taste for a range of mediums, she’s able to tie all the elements of communication into living, breathing brands that have a big and beautiful impact on the world around them.</p>
                </div>
            </div>
        </div>
        <div class="row mypad py-5">
            <div class="col-12 d-flex flex-wrap">
                <div class="col-12 col-md-6" style="font-size: 2rem;">
                    <p class="abril-font center-title m-0" style="text-align: end;">
